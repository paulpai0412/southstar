...
interface Props {
  ...
  hasSession?: boolean;
  /** Hide text label and render icon-only trigger in inline mode */
  iconOnly?: boolean;
}
...
export function BranchNavigator({ tree, activeLeafId, onLeafChange, inline, containerRef, open: openProp, onToggle, hasSession, iconOnly }: Props) {
