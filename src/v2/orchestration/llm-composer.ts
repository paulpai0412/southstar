...
export function renderComposerPrompt(
  ...
  return [
    ...
    "When several producer branches contribute to a combined outcome, ensure a shared integration or evaluator task depends on every producer branch it evaluates.",
