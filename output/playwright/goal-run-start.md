    ...
    - generic [ref=f2e44]:
      ...
      - generic [ref=f2e1138]:
        - generic [ref=f2e1200]:
          ...
          - generic [ref=f2e1250]:
            - generic [ref=f2e1251]:
              - generic [ref=f2e1252]: workflow-generate
              - generic "预估 token 数（流式接收中）" [ref=f2e1253]:
                - generic [ref=f2e1254]: "10"
                - generic [ref=f2e1257]: 10.8 t/s
            - paragraph [ref=f2e1260]: "[request.normalized] request.normalized"
        - generic [ref=f2e1217]:
          - generic [ref=f2e1219]:
            - textbox "Steer 立即注入 / Follow-up 排队…" [ref=f2e1220]
            - generic [ref=f2e1221]:
              - button "Steer" [disabled] [ref=f2e1222]
              - button "Follow-up" [disabled] [ref=f2e1225]
          - generic [ref=f2e1228]:
            - generic [ref=f2e1229]:
              - button "Attach image" [disabled] [ref=f2e1230]
              - button "GPT-5.3 Codex" [disabled] [ref=f2e1236]
            - generic [ref=f2e1241]:
              - button "Stop" [ref=f2e1242] [cursor=pointer]
