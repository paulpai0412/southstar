              ...
              - generic [ref=f2e1383]:
                - generic [ref=f2e1384]:
                  ...
                  - generic [ref=f2e1390]:
                    ...
                    - button "Install selected candidates" [ref=f2e1398] [cursor=pointer]
                    - button "Hide candidates" [ref=f2e1402] [cursor=pointer]
                    - generic [ref=f2e1405]: 3/3 selected
                    - generic [ref=f2e1406]: Complete blocking-gap proposal · all candidates required
                - generic [ref=f2e1407]:
                  - generic [ref=f2e1408]:
                    - checkbox "Offline UI Persistence Verification Report artifact.offline-ui-persistence-verification-report" [checked] [disabled] [ref=f2e1409]
                    - generic [ref=f2e1410]:
                      - generic [ref=f2e1411]:
                  ...
                  - generic [ref=f2e1419]:
                    - checkbox "Reproducible Validation Evidence Map artifact.reproducible-validation-evidence-map" [checked] [disabled] [ref=f2e1420]
                    - generic [ref=f2e1421]:
                      - generic [ref=f2e1422]:
                  ...
                  - generic [ref=f2e1431]:
                    - checkbox "Software Validation Evidence Integrity Evaluator evaluator.software-validation-evidence-integrity" [checked] [disabled] [ref=f2e1432]
                    - generic [ref=f2e1433]:
                      - generic [ref=f2e1434]:
