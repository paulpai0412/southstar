...
function validTemplate(): WorkflowTemplatePayload {
  return {
    ...
    flow: {
      ...
      nodes: [
        { id: "planner", nodeType: "agent_task", name: "Planner", roleRef: "planner", agentProfileRef: "software-dev.agent.planner@1.0.0", contractRefs: ["software-dev.contract.issue-input"], validatorRefs: ["software-dev.validator.schema-evidence-policy@1.0.0"], capabilityRefs: ["software-dev.capability.repo-read-write@1.0.0"], mcpCapabilityRefs: [], workspacePolicyRef: "software-dev.policy.safe-workspace-tork@1.0.0" },
        { id: "implementer", nodeType: "agent_task", name: "Implementer", roleRef: "implementer", agentProfileRef: "software-dev.agent.implementer@1.0.0", contractRefs: ["software-dev.contract.implementation-artifact"], validatorRefs: ["software-dev.validator.schema-evidence-policy@1.0.0"], capabilityRefs: ["software-dev.capability.repo-read-write@1.0.0"], mcpCapabilityRefs: [], workspacePolicyRef: "software-dev.policy.safe-workspace-tork@1.0.0" },
        { id: "checker", nodeType: "agent_task", name: "Checker", roleRef: "checker", agentProfileRef: "software-dev.agent.checker@1.0.0", contractRefs: ["software-dev.contract.verification-artifact"], validatorRefs: ["software-dev.validator.schema-evidence-policy@1.0.0"], capabilityRefs: ["software-dev.capability.browser-ux-verification@1.0.0"], mcpCapabilityRefs: [], workspacePolicyRef: "software-dev.policy.safe-workspace-tork@1.0.0" },
      ],
      edges: [
...
function validPayloads(): Record<string, unknown> {
  return {
    ...
    workflow_recipe: { schemaVersion: "southstar.library.workflow_recipe.v1", baseTemplateRef: "software-dev.template.issue-to-pr-style-todo-web@1.0.0", adaptationRules: [{ condition: "requires browser evidence", action: "add-checker", parameters: { capability: "browser" } }], allowedAgentProfileRefs: ["software-dev.agent.checker@1.0.0"], allowedCapabilityRefs: ["software-dev.capability.browser-ux-verification@1.0.0"], maxTasks: 8, maxParallelTasks: 2 },
    skill_spec: {
